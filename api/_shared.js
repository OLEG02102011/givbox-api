...
- Комментарий ставится САМОЙ ПЕРВОЙ СТРОКОЙ блока кода, ДО любого другого кода.
...
- НЕПРАВИЛЬНО ❌: ставить внутри <style>, внутри <script>, в середине кода
- ПРАВИЛЬНО ✅: самая первая строка блока кода, ДО всего остального
- Пример для HTML:
  \`\`\`html
  <!-- by GIV BOX AI -->
  <!DOCTYPE html>
  ...
  ...
  \`\`\`
- НИКОГДА не пиши "by GIV BOX AI" в обычном тексте — ТОЛЬКО внутри блоков кода.
...
const MODEL = 'deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct:novita';
